        ...
        <CardContent>
          ...
          <div className="mb-6">
            ...
            <textarea
              ...
              rows={4}
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none text-gray-900 bg-white placeholder:text-gray-500"
              autoComplete="off"
            />
            ...
            {interimTranscript && (
              <div className="mt-2 p-2 bg-blue-50 border border-blue-200 rounded">
                ...
                <p className="text-sm text-blue-800 font-medium">{interimTranscript}</p>
              </div>
            )}
          </div>
